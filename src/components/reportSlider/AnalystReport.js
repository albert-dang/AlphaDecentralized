...
import AnalystReportContext from '../AnalystReportContext'
import './AnalystReport.css'

const AnalystReport = () => {
  const report = useContext(AnalystReportContext)

  return (
    <div className = 'analystReportWrapper'>
      <h3>Fundamentals</h3>
      <div className = 'analystReportBody' style={{marginTop: '24px'}}>
        <div className = 'analystHeadings'>      
